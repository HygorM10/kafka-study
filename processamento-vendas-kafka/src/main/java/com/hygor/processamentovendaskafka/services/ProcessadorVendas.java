package com.hygor.processamentovendaskafka.services;
...
import com.hygor.processamentovendaskafka.deserializers.VendaDeserializer;
...
public class ProcessadorVendas {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		properties.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest"); // Pegar todos os registros mesmo os
																				// anteriores
